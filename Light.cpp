...
// durchgefuehrt werden muessen
    ...
    GLfloat light_strength1 [] = {1.0, 1.0, 1.0, 1.0};
	GLfloat light_position2 [] = { -0.5, 1.0, 1.0, 0.0 };
	GLfloat light_position3 [] = { 1.0, 1.0, 1.0, 0.0 };

    glLightfv(GL_LIGHT0, GL_AMBIENT, light_strength1 ); // Ambient Licht Nr. 0 rechts oben
